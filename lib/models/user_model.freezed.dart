...
abstract class $UserEntityCopyWith<$Res> {
  ...
  @useResult
  $Res call({int id, String email, String name, String? password});
}
...
class _$_UserEntity extends _UserEntity {
  ...
  @override
  String toString() {
    return 'UserEntity(id: $id, email: $email, name: $name, password: $password)';
  }
...
class _$_AuthUser implements _AuthUser {
  const _$_AuthUser({required this.user, required this.token});
